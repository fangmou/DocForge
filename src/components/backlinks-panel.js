    ...
    return html`
      <div class="header">
        ...
        ${this.backlinks.length > 0
          ...
          : ''}
        <span class="close" role="button" tabindex="0" title="${t('panel.collapseWithName', { name: t('backlinks.title') })}" @keydown=${activateOnKey} @click=${() => { this.visible = false; this.classList.remove('visible'); }}>
